...
def splitDataset(dataset, splitRatio):
	#splits dataset to training set and test set based on split ratio
...
def classify(data,test):
	...
	for y in range(target.shape[0]):
		...
		print(target[y], count[y], prob[y]) # comptes the probability of target
...
metadata, traindata = read_data("prog6-dataset.csv")
splitRatio = 0.6
